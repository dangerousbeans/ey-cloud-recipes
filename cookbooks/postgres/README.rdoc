...
Postgresql Cookbook for Appcloud.

= LONG DESCRIPTION:

This recipe can install multiple versions of Postgresql.  Currently this is modified by editing the postgres_version in attributes/postgresql.rb
...
* Denotes the version you select in attributes/postgresql.rb
